...
namespace Tether
{
    ...
    public class TetherBrakeState : TetherState
    {
        ...
        public float initialBrakeSpeed; // initial player's vel. when braking state is entered

        public VRCPlayerApi owner;
        public TetherStateOperationsStrat HandleUpdateStrat;
        public TetherStateOperationsStrat CheckStateChangeStrat;
        [SerializeField]
        private TetherBrakeSetHandleUpdateStratLocalVRVisitor setHandleUpdateStratLocalVRVisitor;
        [SerializeField]
        private TetherBrakeSetCheckStateChangeStratLocalVRVisitor setCheckStateChangeStratLocalVRVisitor;
        private LocalVRMode localVRMode;

        public TetherBrakeState Init(GameObject tetherObject, Vector3 hitPoint)
        {
        ...
        public override void Enter(TetherController tetherController)
        {
            ...
            this.initialBrakeSpeed = this.owner.GetVelocity().magnitude;
        ...
        {
            tetherStateVisitor.VisitTetherBrakeState(this);
        }
